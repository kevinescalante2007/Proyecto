...
export class UsuarioService {
  ...
  constructor(private http: HttpClient) { }
      ...
      //  GetNameUser(){
      //     const id= localStorage.getItem('token_User');
      //   return   this.http.get(`${url_usuarioRegistro}/Usuarios/${id}`).pipe(
      //     tap((nomId:any)=>{
      //       console.log(nomId);
      //       console.log(nomId.Nombre_usuario);
    ...
    // enviar a guardar mi imagen de perfil

      // uploadProfileImage(userId: string, file: File): Observable<string | null> {
      //   const formData = new FormData();
      //   formData.append('file', file);
      //   return this.http.put(`${url_usuarioRegistro}/Usuarios/${userId}/Foto`, formData)
      //     .pipe(
      //       map(
      //         (response: any) => {
